...
function LoadBootstrapValidatorScript(callback){
	if (!$.fn.bootstrapValidator){
		$.getScript('static/managefiles/plugins/bootstrapvalidator/bootstrapValidator.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSelect2Script(callback){
	if (!$.fn.select2){
		$.getScript('static/managefiles/plugins/select2/select2.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
//  homepage: /home/f3l1p3/assets_manageuser/js  v4.3.1 license - GPL3
//
function LoadFineUploader(callback){
	if (!$.fn.fineuploader){
		$.getScript('static/managefiles/plugins/fineuploader/jquery.fineuploader-4.3.1.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
$(document).ready(function () {
	...
	/*var ajax_url = location.hash.replace(/^#/, '');
		ajax_url = 'ajax/forms_file_uploader.html';
